        ...
        { $match: matchStage },
        {
            $group: {
                ...
                submitted: {
                    $sum: {
                        $cond: [
                            { $eq: ['$status', ContestStatus.SUBMITTED] },
                            1,
                            0,
                        ],
                    },
                ...
                underReview: {
                    $sum: {
                        $cond: [
                            { $eq: ['$status', ContestStatus.UNDER_REVIEW] },
                            1,
                            0,
                        ],
                    },
                ...
                approved: {
                    $sum: {
                        $cond: [
                            { $eq: ['$status', ContestStatus.APPROVED] },
                            1,
                            0,
                        ],
                    },
                ...
                rejected: {
                    $sum: {
                        $cond: [
                            { $eq: ['$status', ContestStatus.REJECTED] },
                            1,
                            0,
                        ],
                    },
                ...
                withdrawn: {
                    $sum: {
                        $cond: [
                            { $eq: ['$status', ContestStatus.WITHDRAWN] },
                            1,
                            0,
                        ],
                    },
